...
| Piped SQL (FROM SQL) | partial | Experimental `.pipedSql`; supports `FROM ... |> WHERE/SELECT/HAVING/QUALIFY/ORDER BY/LIMIT/OFFSET/JOIN/AGGREGATE`. Additional operators remain. |
